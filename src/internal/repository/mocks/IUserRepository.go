...
func (_m *IUserRepository) GetAllUsers(ctx context.Context) ([]*model.User, error) {
	ret := _m.Called(ctx)
...
func (_m *IUserRepository) GetUserByID(ctx context.Context, id int) (*model.User, error) {
...
func (_m *IUserRepository) Remove(ctx context.Context, email string) error {
	ret := _m.Called(ctx, email)
