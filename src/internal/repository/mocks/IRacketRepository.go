...
// GetAllAvaliableRackets provides a mock function with given fields: ctx
func (_m *IRacketRepository) GetAllAvaliableRackets(ctx context.Context) ([]*model.Racket, error) {
	ret := _m.Called(ctx)

	if len(ret) == 0 {
		panic("no return value specified for GetAllAvaliableRackets")
	}
